        ...
        <footer className="dark:bg-darkBlue-oxford w-full">
            <div className="mx-auto max-w-screen-xl px-4 pb-6 pt-16 sm:px-6 lg:px-8 lg:pt-24">
                <div className="flex flex-col md:flex-row gap-12">
                    <div>
                        <div className="flex justify-center sm:justify-start">
                            <div className="h-16 flex items-end gap-3">
                                <Logo />
                                <h3 className="text-3xl font-bold">کاکتوس سیر</h3>
                            </div>
                            {/* <svg className="hidden h-8" viewBox="0 0 118 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path
                        ...
                        <p className="mt-6 max-w-md text-center leading-relaxed text-gray-500 sm:text-justify">
                        شرکت ما، با سال‌ها تجربه و تخصص، برگزارکننده تورهای داخلی و خارجی از مبدا مشهد، همراه شما برای خلق خاطراتی به‌یادماندنی در هر سفر است.
                        </p>
                        <ul className="mt-8 flex justify-center gap-6 sm:justify-start md:gap-8">
                            <li>
                                <a
                                    ...
                                    rel="noreferrer"
                                    target="_blank"
                                    className="text-gray-500 transition hover:text-pink-700/75"
                                >
                    ...
                    <div className="text-center sm:text-right w-fit order-last">
                            ...
                            <ul className="mt-8 space-y-4 text-sm w-fit">
                                <li>
                                    ...
                                    >
                                        ...
                                        <span className="block text-gray-500">support&nbsp;[at]&nbsp;kaktoosseir.com</span>
                                    </a>
                                </li>

                                <li>
                                    <a
                                        className="flex items-center justify-center gap-3 ltr:sm:justify-start rtl:sm:justify-end"
                                        href="tel:05138668003"
                                    >
                                        <svg
                                            xmlns="http://www.w3.org/2000/svg"
                                            className="size-5 shrink-0 dark:text-gray-300"
                                        ...
                                        <span dir="ltr" className="flex-1 text-gray-500 inline-block">051 - 3866 8003</span>
                                    </a>
                                </li>

                                <li
                                    className="flex items-start justify-center gap-3 ltr:sm:justify-start rtl:sm:justify-end"
                                >
                                    <svg
                                        xmlns="http://www.w3.org/2000/svg"
                                        className="size-5 shrink-0 dark:text-gray-300"
                                    ...
                                    <address className="-mt-0.5 flex-1 not-italic text-gray-500">مشهد، خیابان دانشجو، دانشجو 15، برج آراکس</address>
                                </li>
                            </ul>
                        </div>
                        <div className="text-center sm:text-right">
                            ...
                            <ul className="mt-8 space-y-4 text-sm">
                                ...
                                <li>
                                    <a className="text-gray-500 transition hover:text-gray-700/75" href="#"> فرصت های شغلی </a>
                                </li>
                            </ul>
                        </div>
                        ...
                        <div className="text-center sm:text-right">
                            ...
                            <ul className="mt-8 space-y-4 text-sm">
                                <li>
                                    <a className="text-gray-500 transition hover:text-gray-700/75" href="#"> تورهای خارجی </a>
                                </li>

                                <li>
                                    <a className="text-gray-500 transition hover:text-gray-700/75" href="#"> تورهای داخلی </a>
                                </li>

                                <li>
                                    <a className="text-gray-500 transition hover:text-gray-700/75" href="#"> تور نوروز ۱۴۰۴ </a>
                                </li>
                            </ul>
                        </div>
                    </div>
                ...
                <div className="mt-12 border-t border-gray-100 pt-6">
                    <div className="text-center sm:flex sm:justify-between sm:text-right">
                        ...
                        <p className="mt-4 text-sm text-gray-500 sm:order-first sm:mt-0">&copy; 2025 Kaktoos Seir Toos</p>
                    </div>
                </div>
            </div>
        </footer>
