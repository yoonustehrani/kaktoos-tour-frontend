...
{
    return (
        <nav aria-label="Breadcrumb" className="w-full mx-6 p-3">
            <ol className="text-gray-600 flex items-center gap-3">
                    ...
                    return (
                        <li key={i} className="flex items-center gap-3">
                            {isLast || !l.href ? (
                                ...
                                <Link href={l.href} className="text-blue-600 hover:underline underline-offset-[5px] duration-300 py-1">
                                    <span>{l.text}</span>
                                </Link>
                            )}
                            {!isLast && (
